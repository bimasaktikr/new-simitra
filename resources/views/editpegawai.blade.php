...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('editpegawai.update', $employee->id) }}" method="PUT" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nip" id="nip" value="{{ old('nip', $employee->nip) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:border-blue-500 focus:ring-blue-500" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="email" id="email" value="{{ old('email', $employee->email) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:border-blue-500 focus:ring-blue-500" required>
        </div>
