<nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <div class="flex justify-between h-16 z-10">
        <div class="flex items-center">
            <!-- Hamburger Menu -->
            <button @click="open = !open" id="hamburger" type="button" class="ml-5 p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<div class="flex min-h-screen">
    <!-- Sidebar -->
    <aside :class="{'hidden': !open, 'block': open}" class="fixed inset-y-0 left-0 w-64 bg-gray-800 shadow-lg z-30 lg:block transition-transform transform lg:relative">
