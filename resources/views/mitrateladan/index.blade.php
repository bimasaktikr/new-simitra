    ...
    <div class="flex flex-wrap justify-center gap-4 mb-8">
        ...
        <div class="w-1/6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center">
            <div class="py-8">
                ...
                <a onclick="window.location='{{ route('penilaian2.create', ['mitra_id' => $mitra->id_sobat, 'team' => $mitra->team_id]) }}'" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Nilai</a>
            </div>
        </div>
        @empty
