...
<div class="container p-4 mx-auto dark:bg-gray-900 dark:text-gray-200">
    <h1 class="mb-4 text-3xl font-bold text-gray-900 dark:text-gray-100">Daftar Survei</h1>

    <div class="mt-6">
        <div class="flex justify-between mb-4">
            <div class="relative w-1/3">
                <input type="text" id="search-survey" class="block w-full p-2 pl-10 text-sm bg-white border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" placeholder="Search..." />
                <svg class="absolute w-5 h-5 text-gray-500 transform -translate-y-1/2 top-1/2 left-3 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div id="survey-table" class="p-4 bg-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
...
<div id="deleteModal" class="fixed inset-0 flex items-center justify-center hidden bg-black bg-opacity-50">
    <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Apakah Anda yakin?</h2>
