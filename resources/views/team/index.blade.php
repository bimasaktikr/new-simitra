...
<div class="container mx-auto p-4">
    ...
    <div class="mt-6">
        ...
        <div class="relative w-1/3">
                <input type="text" id="search-team" class="block w-full p-2 pl-10 text-sm border rounded-lg border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" placeholder="Search..." />
        ...
        <form action="{{ route('team') }}" method="GET">
            <div class="flex justify-between mt-4 items-center">
                ...
                <div>
                    {{ $teams->appends(['per_page' => request()->get('per_page', 10)])->links('components.pagination') }}
                </div>
            </div>
        </form>
    </div>
